...
const EN = Object.freeze({
  ...
  '会列出已聊过的私聊/群聊，以及访问名单里记住的联系人与群（显示为昵称 · 电话 / 群名）。': 'Lists known DMs and groups, plus remembered access-list contacts and groups (shown as nickname · phone / group name).',
  '可选投递会话': 'Available delivery conversations',
  '例如 张三 · 13800138000': 'For example, Alice · 13800138000',
  '正在刷新…': 'Refreshing…',
  '刷新': 'Refresh',
