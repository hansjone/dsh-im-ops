...
function MemberRows({
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        "table",
        { className: "dim-accessTable", "data-kind": "member" },
        h2(
          "thead",
          null,
          h2(
        ...
        h2("tbody", null, members.length === 0 ? h2("tr", null, h2("td", { colSpan: 4, className: "dim-accessTableEmpty" }, "\u6682\u65E0\u7528\u6237\uFF0C\u53EF\u70B9\u4E0B\u65B9\u65B0\u589E\u3002")) : members.map((member, index) => h2(
          "tr",
          { key: `member-${index}` },
          h2(
            "td",
