...
function MemberRows({
  ...
  return h2(
    ...
    h2("ul", { className: "dim-accessUserList" }, members.map((member, index) => h2(
      "li",
      { key: `member-${index}`, className: "dim-accessUserRow" },
      h2(
        "label",
        { className: "dim-accessField dim-accessUserId" },
        h2("span", null, "\u7535\u8BDD"),
        ...
        h2(NicknameHint, { contacts, phone: member.phone })
      ),
      h2(
        "label",
        { className: "dim-accessField dim-accessUserCommand" },
...
function AdminPhones({
  ...
  return h2(
    ...
    h2("ul", { className: "dim-accessUserList" }, phones.map((phone, index) => {
      const locked = lockedPhone && phone === lockedPhone;
      return h2(
        "li",
        { key: `admin-${index}`, className: "dim-accessUserRow" },
        h2(
          "label",
          { className: "dim-accessField dim-accessUserId" },
          h2("span", null, locked ? "\u7ED1\u5B9A\u8D26\u53F7\uFF08\u5168\u5C40\u7BA1\u7406\u5458\uFF09" : "\u7535\u8BDD"),
          h2(PhoneTypeahead, {
            value: phone,
            contacts,
          ...
          locked ? null : h2(NicknameHint, { contacts, phone })
        ),
