...
function MemberRows({
  ...
  return h2(
    ...
    h2("ul", { className: "dim-accessCompactList" }, members.map((member, index) => h2(
      "li",
      {
        key: `member-${index}`,
      ...
      h2(
        "div",
        { className: "dim-accessCompactIdentity" },
        h2(PhoneTypeahead, {
          value: member.phone,
          contacts,
          disabled,
...
function AdminPhones({
  ...
  return h2(
    ...
    h2("ul", { className: "dim-accessCompactList" }, phones.map((phone, index) => {
      ...
      return h2(
        ...
        h2(
          ...
          locked ? h2("span", { className: "dim-accessNickname" }, "\u7ED1\u5B9A\u8D26\u53F7\uFF08\u5168\u5C40\u7BA1\u7406\u5458\uFF09") : h2(NicknameHint, { contacts, phone, shortEmpty: true })
        ),
        h2("span", { className: "dim-accessCompactSelectSlot", "aria-hidden": "true" }),
        locked ? h2("span", { className: "dim-accessCompactDeleteSlot", "aria-hidden": "true" }) : h2("button", {
          type: "button",
          className: "dim-deliveryButton dim-accessCompactDelete",
          "data-kind": "danger",
          disabled,
